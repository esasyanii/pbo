// Abstract parent class: tidak bisa dibuat objek langsung, hanya menjadi kerangka untuk subclass
abstract class Kendaraan { // Class induk (superclass)
    private String merk;
    private int tahun;
    ...
    // Method overloading:ada dua method hitungBiayaSewa() dengan parameter berbeda. 
    //agar satu method bisa digunakan untuk dua kebutuhan perhitungan berbeda
    //Menghitung biaya sewa berdasarkan jumlah hari
